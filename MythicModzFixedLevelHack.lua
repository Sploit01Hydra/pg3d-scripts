...
if menu==1 then
gg.alert('Type the required XP amount to level up in the "Level Hack" option, and it will change it to 0. Then go into a public game and get a couple kills. After that, Press the "End Game" option to end the game and recieve your 10-20 xp. With the required amount being 0, you will level up after each repetition. Enjoy! Contact Mythic Modz#0001 on discord for more bug fixes or suggestions!
